...
<?php do_action( 'bkbm_before_single_content',$bkb_cat_tpl_layout ); ?>
        ...
        <?php if (have_posts()) : ?>
            ...
            <header class="bkbm-archive-header">
                ...
                <?php if (category_description() && $bkb_tpl_show_cat_desc == 1) : // Show an optional category description ?>
...
//                            $output .='';
                    ...
                    if ( $bkb_cat_has_child == 1 ) {
                        ...
                        echo do_shortcode('[bkb_category count_info=1 posts_count=1 categories="' . $custom_category_slug . '" cols="1" orderby="'. $bkb_cat_tpl_order_by . '" order="'. $bkb_cat_tpl_order . '" limit="'.$bkb_cat_tpl_ipp.'" bkb_list_type="' . $bkb_list_style_type . '" posts_per_page="' . $bkb_cat_tpl_ipp . '" paginate=0/]');

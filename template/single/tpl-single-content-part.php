...
<header class="bkbm-single-header">
    ...
    <h2 class="bkbm-single-title"><?php the_title(); ?></h2>
...
<div class="bkbm-entry-content">
	...
	<?php wp_link_pages( [ 'before' => '<div class="page-links">' . __( 'Pages:', 'bkb_tpl' ), 'after' => '</div>' ] ); ?>
</div><!-- .entry-content -->
...
<div class="bkbm-grid bkbm-grid-pad nav-single bwl-row-cols-2">
    <div>
    <span
        class="nav-previous"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'bkb_tpl' ) . '</span> %title' ); ?>&nbsp;</span>
    </div>
    <div class="text-right">
    <span
        class="nav-next">&nbsp;<?php next_post_link( '%link', '%title <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'bkb_tpl' ) . '</span>' ); ?></span>
    </div>
</div><!-- .nav-single -->

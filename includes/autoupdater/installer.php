...
add_action("wp_ajax_bkbm_tpl_installation_counter", "bkbmTplAddInstallationData");
add_action("wp_ajax_nopriv_bkbm_tpl_installation_counter", "bkbmTplAddInstallationData");

function bkbmTplApiUrl()
{
...
function bkbmTplAddInstallationData()
{
